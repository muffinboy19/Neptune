...
class messageAdapter(val context :Context,val messageList:ArrayList<messaage>) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    class ReciveViewHolder(itemView: View) :RecyclerView.ViewHolder(itemView){
        val reccivetmessage = itemView.findViewById<TextView>(R.id.textreccived
        )
